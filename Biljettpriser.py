...
# Försöker ta indata för dagarPerVecka. Om det inte är en siffra så funkar inte rad 8 och då gör den det som står under except istället!
while True:
    try: 
        dagarPerVecka = int(input("Hur många dagar i veckan åker du med kollektivtrafiken? (svara med en siffra) "))
        break
    except:
        print("Du måste skriva in en siffra, gör om!")

# Tar indata för om användaren får köpa rabatterad biljett
